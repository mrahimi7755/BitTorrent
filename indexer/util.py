...
def collapse(data):
    """Concatenates items of a homogeneous list together."""
    return reduce(lambda x, y: x + y, data)

def slice_string(string, n):
    """Slices a string into sub-strings of size n."""
    temp = []
    i = n
    while i <= len(string):
...
def convert(byte_dict):
    """Converts keys and values of a dictionary from bytes to strings."""
    normal_dict = {}
    normal_info_dict = {}
